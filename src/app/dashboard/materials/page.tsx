...
export default function MaterialsPage() {
    const { user } = useAuth();
    const { setSummary, setFlashcards, setDocumentTitle, setStudyMaterial } = useContext(StudyMaterialContext);
    ...
    const handleLoadMaterial = (material: Material) => {
        ...
        toast({ title: 'Study Set Loaded', description: 'The summary and flashcards are now active in all AI tools.' });
    ...
    const handleDeleteMaterial = async (materialId: string) => {
        ...
        try {
            ...
            toast({ title: 'Success', description: 'Study set deleted successfully.' });
        } catch (error) {
            toast({ variant: 'destructive', title: 'Error', description: 'Failed to delete study set.' });
        }
    };
        ...
        <div className="space-y-8">
             <div>
                ...
                <p className="text-muted-foreground">
                    Here are all your saved study sets. Load one to review the summary and flashcards.
                </p>
            </div>
            ...
            {materials.length === 0 ? (
                <Card className="text-center p-10 bg-secondary/50 border-dashed">
                    <CardHeader>
                        ...
                        <CardDescription>You haven't saved any study sets yet.</CardDescription>
                    </CardHeader>
                    <CardContent>
                         <Button asChild>
