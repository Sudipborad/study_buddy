...
import { DocumentChatbot } from "@/components/dashboard/document-chatbot";
...
export default function ChatbotPage() {
        ...
        return (
             <Card className="w-full max-w-lg mx-auto mt-10 text-center">
                <CardHeader>
                    ...
                    <CardDescription>
                        Please upload your study material first to start a chat session.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Button asChild>
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold font-headline">Document Chatbot</h1>
                <p className="text-muted-foreground">
                    Ask questions and get answers based on your uploaded material.
                </p>
            </div>
            <DocumentChatbot />
        </div>
